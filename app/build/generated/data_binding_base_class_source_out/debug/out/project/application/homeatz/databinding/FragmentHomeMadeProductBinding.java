...
public final class FragmentHomeMadeProductBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeMadeProductBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView ivRegionBanner, @NonNull LinearLayout ll1, @NonNull TextView recommendedTv,
      @NonNull RecyclerView recyclerView, @NonNull LinearLayout sortLayout,
  ...
  @NonNull
  public static FragmentHomeMadeProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeMadeProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_made_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeMadeProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeMadeProductBinding((LinearLayout) rootView, belowHeaderLl, bottomLl,
          cartCountTxtV, cartImg, cartPriceTxtV, ivRegionBanner, ll1, recommendedTv, recyclerView,
          sortLayout, viewCartTv);
    }
