...
public final class RowManageAddressBinding implements ViewBinding {
  @NonNull
  ...
  private RowManageAddressBinding(@NonNull CardView rootView, @NonNull LinearLayout addressCv,
      @NonNull TextView addressTv, @NonNull TextView addresslabelTv,
      @NonNull TextView deleteAddressTv, @NonNull TextView editAddressTv, @NonNull TextView phoneTv,
      @NonNull TextView pinCodeTv) {
    ...
    this.editAddressTv = editAddressTv;
  ...
  @NonNull
  public static RowManageAddressBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowManageAddressBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_manage_address, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowManageAddressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editAddress_tv;
      TextView editAddressTv = ViewBindings.findChildViewById(rootView, id);
      if (editAddressTv == null) {
        break missingId;
      }
      ...
      return new RowManageAddressBinding((CardView) rootView, addressCv, addressTv, addresslabelTv,
          deleteAddressTv, editAddressTv, phoneTv, pinCodeTv);
    }
