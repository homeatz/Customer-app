...
public final class FragmentFaqBinding implements ViewBinding {
  ...
  private FragmentFaqBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerview) {
  ...
  public static FragmentFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFaqBinding((LinearLayout) rootView, recyclerview);
    }
